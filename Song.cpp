...
void SONG::ReadCrazy_1_STF(char *Filename)
{
	...
	GetFullPathName("Title.bmp",MAX_PATH,TitlePath,&lpPart);
	GetFullPathName("Back.bmp",MAX_PATH,BMPPath,&lpPart);
	GetFullPathName("Song.wav",MAX_PATH,WavName,&lpPart);
	GetFullPathName("Song.mp3",MAX_PATH,MP3Name,&lpPart);
	GetFullPathName("Song.mpg",MAX_PATH,MPGName,&lpPart);
	GetFullPathName("Intro.wav",MAX_PATH,WavsName,&lpPart);
	GetFullPathName("Intro.mp3",MAX_PATH,Wavs3Name,&lpPart);
